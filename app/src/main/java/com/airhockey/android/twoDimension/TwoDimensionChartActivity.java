...
public class TwoDimensionChartActivity extends Activity implements View.OnClickListener {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (supportsEs2) {
            ...
            glSurfaceView.setRenderer(renderer = new TwoDimensionChartRenderer(this));
            rendererSet = true;
        } else {
    ...
    public void onClick(View v) {
        if(v.getId() == R.id.open_device){
            ...
            if(ssid.startsWith(Constants.HEADSSID)){
                Toast.makeText(TwoDimensionChartActivity.this,"设备"+ssid+"已经连接，即将传输数据",Toast.LENGTH_SHORT).show();
